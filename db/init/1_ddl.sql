...
-- -----------------------------------------------------
-- Schema go_college_api
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema go_college_api
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `go_college_api` DEFAULT CHARACTER SET utf8mb4 ;
USE `go_college_api` ;

SET CHARSET utf8mb4;

-- -----------------------------------------------------
-- Table `go_college_api`.`user`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `go_college_api`.`collection_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_college_api`.`collection_item` (
...
-- -----------------------------------------------------
-- Table `go_college_api`.`user_collection_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_college_api`.`user_collection_item` (
...
-- -----------------------------------------------------
-- Table `go_college_api`.`gacha_probability`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_college_api`.`gacha_probability` (
  `collection_item_id` VARCHAR(128) NOT NULL COMMENT 'コレクションアイテムID',
